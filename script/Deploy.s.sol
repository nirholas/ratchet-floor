...
/**
 * @title DeployRatchetFloor
 * @notice Deploys RatchetFloor deterministically to any chain with a Uniswap v4 `PoolManager`.
 *
 ...
 */
contract DeployRatchetFloor is Script {
    ...
    function run() external {
        ...
        bytes memory creationCode = type(RatchetFloorHook).creationCode;
        ...
        console2.log("RatchetFloor ", predicted);
        ...
        require(
            keccak256(bytes(IHookMetadata(address(hook)).hookName())) == keccak256(bytes("RatchetFloor")),
